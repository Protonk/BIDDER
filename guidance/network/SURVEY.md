...
This survey is one of three related artifacts:

- **`guidance/network/SURVEY.md`** (this file) — navigation.
  *Where is X? What shelf?*
- **`guidance/network/surveys/`** (forthcoming) — content.
  *What does X say?*
- [`COLLECTION.md`](../../COLLECTION.md) — argument.
