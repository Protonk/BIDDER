# Finite Rank Expansion (index)

Successor index. The contents of this file have been split across
canonical homes; this page exists only to redirect external
cross-references that still point at `FINITE-RANK-EXPANSION.md`. New
material goes in the canonical files below.

| former section                          | canonical location           |
|---|---|
| Definitions of M_n, Q_n, h, ν_n         | `OBJECTS.md`                 |
| Master expansion (Mercator log)         | `MASTER-EXPANSION.md`        |
