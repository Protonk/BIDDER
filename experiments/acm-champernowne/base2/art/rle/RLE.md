...
The shared implementation lives in [`../../binary_core.py`](../../binary_core.py).
The quantitative argument for why this matters lives in
[`../../BINARY.md`](../../BINARY.md) and the more analytic
companions under [`../../forest/`](../../forest/).
...
[`../../forest/boundary_stitch/`](../../forest/boundary_stitch/).
