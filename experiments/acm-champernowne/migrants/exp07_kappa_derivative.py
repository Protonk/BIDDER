...
def main():
    ...
    # Cache for downstream cross-cuts (e.g. lattice_alignment.py).
    np.savez(os.path.join(HERE, 'exp07_lattice.npz'),
             COLL=COLL, S_GRID=S_GRID, N0_VALUES=N0_VALUES,
             K_MAX=K_MAX, W=W)
    print(f'-> exp07_lattice.npz')
